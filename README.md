...
## News
+ [Mar 2020] We achieve state-of-the-art query efficiency also for *targeted* Linf attacks.
...
is situated approximately at the boundary of the feasible set. 
Our method is significantly more query efficient and achieves a higher success rate compared to the state-of-the-art 
methods, especially in the untargeted setting.  
In particular, on ImageNet we improve the average query efficiency in the untargeted setting for various deep networks 
...
Below we show adversarial examples generated by our method for Linf and L2:
...
<p align="center"><img src="images/table_madry_trades_mnist.png" width="400"></p>

Performance of our L2 attack on the Linf robust Madry model:
<p align="center"><img src="images/table_madry_mnist_l2.png" width="400"></p>
